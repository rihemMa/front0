...
get client_id() { return this.clientForm.get('client_id')
  ...
  let billId = this.activatedRoute.snapshot.params.id
     ...
     this.billService.updateBill(billId, this.invoice.products,this.invoice.tvaObj).subscribe(
       res=>{
      ...
      content: [
        {
          columns: [
            ...
            [
              ...
              {
                text: `Date de Facturation :  `+' '+ new Date(this.DateFacturation).getFullYear()+"-"+new Date(this.DateFacturation).getMonth()+"-"+new Date(this.DateFacturation).getDay(),
                alignment: 'right',
                fontSize: 10,
              },
            ]
                          ...
                          },
                          {
                            table: {
                              ...
                              body: [
                                ...
                                [{text:'Montant en toute lettres', style: 'RowFont' }, this.invoice.tvaObj.inWord ],
                              ]
                            },
                            layout:  {
                            hLineWidth: function (i, node) {
  ...
  formBillNum(){
    ...
    let date = new Date(this.DateFacturation).getFullYear()
